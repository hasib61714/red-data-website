...
export const blogPostsData = [
  {
    ...
    body: [
      { type: 'p', text: 'রেড ডাটা লিমিটেড ২০১২ সাল থেকে বাংলাদেশের ইন্টারনেট সেবা খাতে নেতৃত্ব দিয়ে আসছে। BTRC অনুমোদিত এই ISP কোম্পানি দেশের ৬৪টি জেলায় হাই-স্পিড ফাইবার ব্রডব্যান্ড, কর্পোরেট ইন্টারনেট, ডেটা কানেক্টিভিটি, আইপি টেলিফোনি এবং ম্যানেজড আইটি সার্ভিস প্রদান করে থাকে।' },
      { type: 'h2', text: 'কেন রেড ডাটা বাংলাদেশের সেরা?' },
      { type: 'p', text: 'রেড ডাটা তার প্রতিযোগীদের থেকে আলাদা কারণ এটি শুধু ইন্টারনেট সংযোগ নয়, একটি সম্পূর্ণ ডিজিটাল সমাধান প্রদান করে। ৯৯.৯% আপটাইম গ্যারান্টি, ২৪/৭ NOC মনিটরিং এবং দ্রুত ইনস্টলেশন সেবা নিয়ে রেড ডাটা হাজার হাজার পরিবার ও ব্যবসায়িক প্রতিষ্ঠানের বিশ্বাসের প্রতিষ্ঠানে পরিণত হয়েছে।' },
      { type: 'h2', text: 'আমাদের সেবাসমূহ' },
      { type: 'ul', items: ['হোম ইন্টারনেট — ১৫ Mbps থেকে ১০০ Mbps পর্যন্ত সাশ্রয়ী প্ল্যান', 'কর্পোরেট ইন্টারনেট — SLA-সমর্থিত ডেডিকেটেড ব্যান্ডউইথ', 'ডেটা কানেক্টিভিটি — পয়েন্ট-টু-পয়েন্ট ও MPLS লিংক', 'আইপি টেলিফোনি — ক্লাউড PBX ও কল সেন্টার সমাধান', 'SMS সার্ভিস — বাল্ক মেসেজিং ও OTP গেটওয়ে', 'ডোমেইন ও হোস্টিং — NVMe স্টোরেজসহ রিলায়েবল হোস্টিং', 'ম্যানেজড সার্ভিস — সম্পূর্ণ আইটি ইনফ্রাস্ট্রাকচার ম্যানেজমেন্ট'] },
      { type: 'h2', text: 'ফাইবার অপটিক নেটওয়ার্ক' },
      { type: 'p', text: 'রেড ডাটার ফাইবার অপটিক নেটওয়ার্ক বাংলাদেশের সব প্রধান শহর ও উপজেলা পর্যন্ত বিস্তৃত। এই অত্যাধুনিক প্রযুক্তি ব্যবহার করে আমরা আমাদের গ্রাহকদের সর্বোচ্চ গতি ও সর্বনিম্ন লেটেন্সি নিশ্চিত করি। মাল্টিপল আপস্ট্রিম ক্যারিয়ার কানেকশনের মাধ্যমে আমাদের নেটওয়ার্ক সর্বদা সচল থাকে।' },
      { type: 'h2', text: '২৪/৭ গ্রাহক সহায়তা' },
      { type: 'p', text: 'রেড ডাটার গ্রাহক সহায়তা দল ২৪ ঘণ্টা, সপ্তাহের ৭ দিন আপনার সেবায় নিয়োজিত। ফোন, WhatsApp, ইমেইল বা Facebook Messenger — যেকোনো মাধ্যমে আমাদের সাথে যোগাযোগ করুন এবং দ্রুত সমাধান পান।' },
      { type: 'p', text: 'আজই রেড ডাটার সাথে সংযুক্ত হন এবং বাংলাদেশের সেরা ইন্টারনেট অভিজ্ঞতা উপভোগ করুন। আমাদের বিশেষজ্ঞ দল আপনার জন্য সঠিক সমাধান খুঁজে দিতে সদা প্রস্তুত।' },
    ],
  },
  {
    id: 2,
    ...
    body: [
      { type: 'p', text: "In today's fast-paced digital economy, a reliable and high-speed internet connection is no longer a luxury — it is a critical business necessity. For Bangladeshi companies operating in competitive markets, corporate internet services offer significant advantages over standard residential plans." },
      { type: 'h2', text: 'What is Corporate Internet?' },
      { type: 'p', text: 'Corporate internet services provide dedicated bandwidth exclusively for your business, unlike shared residential connections where speed fluctuates based on neighbourhood usage. With a dedicated leased line, your office gets consistent, guaranteed speeds 24 hours a day, 7 days a week — backed by a formal Service Level Agreement (SLA).' },
      { type: 'h2', text: 'Key Benefits for Bangladeshi Businesses' },
      { type: 'ul', items: ['Guaranteed Uptime SLA — 99.9% uptime commitment with financial penalties if breached', 'Dedicated Bandwidth — No sharing with neighbours; full speed at all times', 'Symmetric Speeds — Equal upload and download speeds for video calls, cloud uploads, VPN', 'Priority Support — Dedicated account manager and rapid on-site response', 'Scalable Capacity — Upgrade bandwidth instantly as your business grows', 'BGP Routing — Multiple upstream carriers for automatic failover'] },
      { type: 'h2', text: 'Impact on Business Productivity' },
      { type: 'p', text: 'Studies show that internet downtime costs Bangladeshi businesses an average of BDT 50,000–200,000 per hour in lost productivity, missed transactions, and damaged customer relationships. A corporate internet plan with SLA guarantees dramatically reduces this risk, ensuring your operations continue smoothly even during peak hours.' },
      { type: 'h2', text: 'Enabling Remote Work & Digital Transformation' },
      { type: 'p', text: 'Post-pandemic Bangladesh has seen a surge in remote and hybrid work models. Corporate internet services with VPN support, cloud connectivity, and video conferencing-optimised routing enable your team to collaborate effectively from anywhere. This connectivity backbone is also essential for businesses adopting ERP systems, cloud accounting, and digital payment infrastructure.' },
      { type: 'h2', text: 'Red Data Corporate Plans' },
      { type: 'p', text: 'Red Data offers customised corporate internet packages starting from dedicated 10 Mbps links up to 10 Gbps+ for large enterprises. All plans include free on-site installation, 24/7 NOC monitoring, and a dedicated technical account manager. Contact our enterprise team today for a custom quote tailored to your business requirements.' },
    ],
  },
  {
    id: 3,
    ...
    body: [
      { type: 'p', text: "With dozens of ISPs operating across Bangladesh, selecting the right home internet provider can feel overwhelming. Speed numbers on advertisements rarely tell the whole story. This guide will help you make an informed decision based on what actually matters for your household." },
      { type: 'h2', text: '1. Check Coverage First' },
      { type: 'p', text: 'Before comparing plans, verify that the ISP actually provides service in your specific area. Some providers advertise nationwide coverage but may not have infrastructure in your neighbourhood or building. Always ask for a coverage check before signing up — a good ISP will confirm this within minutes.' },
      { type: 'h2', text: '2. Speed: What Do You Actually Need?' },
      { type: 'ul', items: ['15–20 Mbps — Basic browsing, social media, standard YouTube for 1–2 users', '30–40 Mbps — HD streaming, video calls, gaming for a small family', '50–60 Mbps — 4K streaming on multiple devices simultaneously', '100 Mbps+ — Heavy streaming, large file uploads, multiple power users'] },
      { type: 'h2', text: '3. Reliability Over Raw Speed' },
      { type: 'p', text: 'A 50 Mbps connection that drops every evening is far more frustrating than a consistent 20 Mbps line. Look for providers who publish their uptime SLA, have a proven track record, and offer NOC monitoring. Ask neighbours or check online reviews about actual real-world performance — not just advertised speeds.' },
      { type: 'h2', text: '4. Evaluate Customer Support' },
      { type: 'p', text: 'Internet issues happen. When they do, you need prompt support. Evaluate whether the ISP offers 24/7 helpline access, WhatsApp or chat support, and committed response time SLAs. An ISP that takes 3 days to send a technician is no good regardless of how affordable their plan is.' },
      { type: 'h2', text: '5. Transparent Pricing & BTRC Approval' },
      { type: 'p', text: 'Always choose a BTRC-licensed ISP with publicly available tariff information. Avoid providers with unclear contracts, hidden installation fees, or non-standard pricing. Reputable ISPs display all charges upfront including VAT, one-time setup fees, and monthly plan costs.' },
      { type: 'h2', text: '6. Look for Value-Added Features' },
      { type: 'ul', items: ['Free installation with your plan', 'Talk-time minutes bundled with the connection', 'OTT platform access (streaming subscriptions) on higher plans', 'Self-care portal for bill payment and usage monitoring', 'Easy plan upgrade/downgrade options'] },
      { type: 'p', text: "Red Data's home internet plans are designed with all these factors in mind — transparent pricing, proven reliability, 24/7 support, and free installation. Explore our packages starting from ৳525/month and find the plan that fits your family perfectly." },
    ],
  },
]
