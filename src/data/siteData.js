...
export const dataConnectivityData = {
  features: [
    ...
    { icon: 'Radio', title: 'CP Network', title_bn: 'সিপি নেটওয়ার্ক', desc: 'Gain access to all five operators: Grameenphone, Banglalink, Airtel, Robi & Teletalk. We are specialized in establishing connectivity network for Content Service Providers. Our Network is connected with direct, private connections to all five Mobile Network Operators which allows traffic to flow directly to Content Service Providers without traversing public peering points.', desc_bn: 'পাঁচটি অপারেটরের অ্যাক্সেস পান: গ্রামীণফোন, বাংলালিংক, এয়ারটেল, রবি ও টেলিটক। কন্টেন্ট সার্ভিস প্রোভাইডারদের জন্য কানেক্টিভিটি নেটওয়ার্ক প্রতিষ্ঠায় আমরা বিশেষজ্ঞ।' },
    { icon: 'Network', title: 'Backhaul Service', title_bn: 'ব্যাকহল সার্ভিস', desc: 'Backhaul services provide the necessary infrastructure to connect various network elements, such as cell towers or hub sites, to the core network. We offer scalable and reliable backhaul solutions to meet the growing demands of data traffic.', desc_bn: 'ব্যাকহল সার্ভিস সেল টাওয়ার বা হাব সাইটের মতো বিভিন্ন নেটওয়ার্ক উপাদানকে কোর নেটওয়ার্কে সংযুক্ত করার জন্য প্রয়োজনীয় অবকাঠামো প্রদান করে। ক্রমবর্ধমান ডেটা ট্রাফিকের চাহিদা পূরণে আমরা স্কেলেবল ও নির্ভরযোগ্য ব্যাকহল সমাধান অফার করি।' },
  ],
  stats: [
  ...
  services: [
    {
      ...
      desc: 'Experience seamless operations with our Managed Services. We handle the intricacies, so you can focus on your core business. Let us optimize your infrastructure, ensuring efficiency and reliability.',
      desc_bn: 'আমাদের ম্যানেজড সার্ভিসের মাধ্যমে নিরবচ্ছিন্ন অপারেশন উপভোগ করুন। আমরা জটিলতাগুলো সামলাই, আপনি আপনার মূল ব্যবসায় মনোযোগ দিন। আমাদের ইনফ্রাস্ট্রাকচার অপ্টিমাইজ করতে দিন।',
    ...
    },
    {
      ...
      bgColor: 'bg-red-50 dark:bg-red-500/10',
      borderColor: 'border-red-200 dark:border-red-500/30',
      desc: 'Safeguard your network with our Managed Network Security Service. Our experts tirelessly monitor and protect your systems against threats, allowing you to operate worry-free in a secure digital environment.',
      desc_bn: 'আমাদের ম্যানেজড নেটওয়ার্ক সিকিউরিটি সার্ভিস দিয়ে আপনার নেটওয়ার্ক সুরক্ষিত করুন। আমাদের বিশেষজ্ঞরা অক্লান্তভাবে আপনার সিস্টেম মনিটর ও হুমকি থেকে রক্ষা করেন।',
    ...
    },
    {
      ...
      bgColor: 'bg-red-50 dark:bg-red-500/10',
      borderColor: 'border-red-200 dark:border-red-500/30',
      desc: 'Leverage our expertise in Managed Software & Embedded System Development. We bring innovation to your digital products, managing the entire lifecycle, from concept to deployment, for a competitive edge in your industry.',
      desc_bn: 'ম্যানেজড সফটওয়্যার ও এমবেডেড সিস্টেম ডেভেলপমেন্টে আমাদের দক্ষতা কাজে লাগান। আমরা আপনার ডিজিটাল পণ্যে উদ্ভাবন নিয়ে আসি, কনসেপ্ট থেকে ডিপ্লয়মেন্ট পর্যন্ত সম্পূর্ণ জীবনচক্র পরিচালনা করি।',
...
export const homeInternetPageData = {
  plans: [
    ...
    { name: 'Cherry',   price: 630,  base: 600,  vat: 30,  speed: 20,  oneTime: 2500, talkTime: 50,  ott: 0, tag: 'Most Popular',      tagColor: 'bg-red-100 text-red-600 dark:bg-red-500/20 dark:text-red-300',             popular: false,  color: 'from-red-500 to-rose-600' },
    ...
    { name: 'Scarlet',  price: 1050, base: 1000, vat: 50,  speed: 50,  oneTime: 1000, talkTime: 200, ott: 1, tag: 'Affordable',        tagColor: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300', popular: false, color: 'from-red-600 to-red-700' },
