...
const plans = [
  ...
  },
  {
    ...
    ott: 0,
    tag: 'Most Popular',
    tagColor: 'bg-red-100 text-red-600 dark:bg-red-500/20 dark:text-red-300',
    popular: true,
  ...
  },
  {
    ...
    tagColor: 'bg-orange-100 text-orange-600 dark:bg-orange-500/20 dark:text-orange-300',
    popular: false,
  ...
  },
  {
    ...
    ott: 1,
    tag: 'Family Plan',
    tagColor: 'bg-purple-100 text-purple-600 dark:bg-purple-500/20 dark:text-purple-300',
    popular: false,
